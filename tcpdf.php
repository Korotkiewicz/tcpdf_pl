...
class TCPDF {
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false) {
		...
		$this->InFooter = false;
		$this->lasth = 0;
		$this->FontFamily = 'dejavuserifcondensed';
		$this->FontStyle = '';
		$this->FontSizePt = 12;
		...
		$this->CoreFonts = array(
			...
			'dejavuserifcondensed'=>'Times-Roman',
			'timesB'=>'Times-Bold',
			'timesI'=>'Times-Italic',
	...
	public function Close() {
		...
		$this->lMargin = 0;
		$this->_out('q');
		$this->SetFont('dejavuserifcondensed', '', 1);
	...
	protected function _putcatalog() {
		...
		if (!empty($this->form_obj_id) OR ($this->sign AND isset($this->signature_data['cert_type']))) {
			...
			$font = $this->getFontBuffer('dejavuserifcondensed');
...
Putting 1 is equivalent to putting 0 and calling Ln() just after. Default value: 0.
	...
	public function getFontFamilyName($fontfamily) {
		...
		foreach ($fontslist as $font) {
			...
			$replacement[] = 'dejavuserifcondensed';
			$pattern[] = '/^sansserif/';
			$replacement[] = 'dejavuserifcondensed';
			$pattern[] = '/^monospace/';
			$replacement[] = 'courier';
