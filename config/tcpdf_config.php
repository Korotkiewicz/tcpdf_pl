...
$k_path_main = APPLICATION_PATH . 'tcpdf' . DS;
/* str_replace( '\\', '/', realpath(substr(dirname(__FILE__), 0, 0-strlen('config'))));
...
$k_path_url = constant('baseUrl') . '/tcpdf/';
...
define('PDF_FONT_NAME_HEADERFOOTER', 'dejavuserifcondensed');
...
if (!defined('PDF_FONT_SIZE_HEADER'))
    define('PDF_FONT_SIZE_HEADER', 8);
if (!defined('PDF_FONT_SIZE_FOOTER'))
    define('PDF_FONT_SIZE_FOOTER', 6);
